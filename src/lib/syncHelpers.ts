...
export function getSupabaseTableName(storeName: string): string {
  const mapping: Record<string, string> = {
    ...
    coatingInventory: 'coating_inventory',
    shoppingItems: 'shopping_items',
    commTemplates: 'comm_templates',
    referralAssociates: 'referral_associates',
    referralServices: 'referral_services',
...
export function getIndexedDBStoreName(tableName: string): string {
  const mapping: Record<string, string> = {
    ...
    customers: 'customers',
    leads: 'leads',
    lead_appointments: 'leadAppointments',
    products: 'products',
    base_coat_colors: 'baseCoatColors',
    chip_blends: 'chipBlends',
    jobs: 'jobs',
    chip_inventory: 'chipInventory',
    tint_inventory: 'tintInventory',
    coating_inventory: 'coatingInventory',
    shopping_items: 'shoppingItems',
    comm_templates: 'commTemplates',
    referral_associates: 'referralAssociates',
    referral_services: 'referralServices',
