...
export async function pushToSupabase(): Promise<{
  ...
  try {
    ...
    const storeGetters: Record<string, () => Promise<any[]>> = {
      ...
      coatingInventory: getAllCoatingInventoryForSync,
...
export async function pushAllToSupabase(options?: { bumpTimestamps?: boolean }): Promise<{
  ...
  try {
    ...
    const tablesToSync = [
      ...
      { store: 'coatingInventory', getter: getAllCoatingInventoryForSync },
      ...
      { store: 'adSpend', getter: getAllAdSpendForSync },
